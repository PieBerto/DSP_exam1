...
const collaborationController = require(path.join(__dirname, 'controllers/CollaborationController'));
const draftReviewController = require(path.join(__dirname, 'controllers/DraftReviewController'));
...
var draftReviewSchema = JSON.parse(fs.readFileSync(path.join('.', 'json_schemas', 'draftReview_schema.json')).toString());
var collaborationSchema = JSON.parse(fs.readFileSync(path.join('.', 'json_schemas', 'collaboration_schema.json')).toString());
var validator = new Validator({ allErrors: true });
validator.ajv.addSchema([userSchema, filmSchema, reviewSchema, draftReviewSchema, collaborationSchema]);
...
//New code
app.get('/api/films/public/collaborationReviews/:collaborationId',isLoggedIn,collaborationController.getSingleCollaborationReview);
app.get('/api/films/public/:filmId/collaborationReviews',collaborationController.getCollaborationReviews);
app.post('/api/films/public/:filmId/collaborationReviews',isLoggedIn,collaborationController.createCollaborationReview);
app.get('/api/films/public/:filmId/collaborationReviews/:reviewerId',isLoggedIn,collaborationController.getUserCollaborationReviews);
app.get('/api/films/public/:filmId/collaborationReviews/:reviewerId/drafts',isLoggedIn,draftReviewController.getOpenCollaborationDraft);
app.post('/api/films/public/:filmId/collaborationReviews/:reviewerId/drafts',isLoggedIn,validate({body: collaborationSchema}),draftReviewController.CreateOpenCollaborationDraft);
app.put('/api/films/public/:filmId/collaborationReviews/:reviewerId/drafts',isLoggedIn,validate({body:draftReviewSchema}),draftReviewController.modifyOpenCollaborationDraft);
//End new code
